      ...
      <div class="popup-content">
        ...
        <form @submit.prevent="">
          ...
          <div class="group">
            ...
            <div class="ingredent" v-for="i in newRecipe.ingredentRows"
            :key="i">
              <input type="text" v-model="newRecipe.ingredents[ i - 1]"  />  
            </div>
            
            <button @click="addNewIngredent" type="button">Add Ingredient</button>
          </div>

          <div class="group">
            <label >Methods</label>
            <div class="methods" v-for="i in newRecipe.methodRows"
            :key="i">
              <textarea v-model="newRecipe.method[i - 1]" name="" id="" cols="30" rows="10"></textarea>
...
//import { useStore } from 'vuex';   //access store from composition API
export default {
  name: 'HomeView',
  setup(){
    const newRecipe = ref({
